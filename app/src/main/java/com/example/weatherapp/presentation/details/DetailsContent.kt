...
import com.example.weatherapp.presentation.extesions.formattedFullDate
...
private fun Forecast(forecast: Forecast) {
    Column(
        ...
        Row(
            ...
            Text(
                text = forecast.currentWeather.temp.tempToFormattedString(),
...
private fun RowScope.SmallWeatherCard(weather: Weather) {
    Card(
        ...
        Column(
            ...
            Text(text = weather.temp.tempToFormattedString())
            GlideImage(
